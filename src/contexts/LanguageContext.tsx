...
const translations: Record<Language, Record<string, string>> = {
  ar: {
    ...
    'courses.subtitle.group': 'لأن أهدافك بالعبرية فريدة، صممنا لك مساراً فردياً بالكامل. من التأسيس المدرسي وحتى التفوق في البجروت وامتحان ياعيل (יע"ל)، نبني برنامجك الخاص ليعالج ثغراتك بدقة مع تركيز جوهري على المحادثة.',
    'courses.subtitle.enSolo': 'أتقن الإنجليزية بمسار فردي (1:1) يُصمم خصيصاً لأهدافك. من تجاوز عقبات البجروت إلى انتزاع الإعفاء الجامعي (Amir/Amiram)، نمنحك الثقة الكاملة في التحدث والنطق الطبيعي بذكاء واحترافية.',
