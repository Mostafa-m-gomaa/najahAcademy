...
const translations: Record<Language, Record<string, string>> = {
  ar: {
    ...
    'hero.titleAccent': 'ومع أفضل المعلمات',
...
لطلاب المدارس، الجامعات، وأصحاب المهن. نضمن لك كسر حاجز الخوف والتحضير الشامل لامتحانات البجروت، ياعيل، وأمير مع أفضل المعلمات الأكاديميات`,
    ...
    'about.story': 'تأسس آكاديمية نجاح 2200 بهدف تمكين المجتمع العربي من إتقان اللغات العبرية والإنجليزية بأعلى معايير الجودة والاحترافية.',
