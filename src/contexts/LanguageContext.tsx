...
const translations: Record<Language, Record<string, string>> = {
  ar: {
    ...
    // Hero
    'hero.title': 'أتقن العبرية والإنجليزية بطلاقة في أقوى الدورات ',
    'hero.titleAccent': ' و  مع أفضل المعلمات ',
    'hero.subtitle': ` تحدث بطلاقة اليوم عبر دوراتنا الفردية أو الجماعية، ببرامج احترافية مخصصة 
لطلاب المدارس، الجامعات، وأصحاب المهن. نضمن لك كسر حاجز الخوف والتحضير الشامل لامتحانات البجروت، ياعيل، وأمير مع أفضل المعلمات الأكاديميات`,
    'hero.cta1': 'ابدأ الآن',
    ...
    // Courses
    'courses.title.solo': 'دوراتنا  للغه العبريه الفردية',
    'courses.title.group': 'دوراتنا  للغه العبريه الجماعية',
    'courses.title.enSolo': 'دوراتنا للغه الانجليزية الفردية',
    'courses.title.enGroup': 'دوراتنا في اللغه الانجليزية',
    'courses.subtitle.solo': 'لأن كل طالب هو حالة فريدة، نؤمن بالتعليم الفردي المطلق. في أكاديميتنا، لا نعتمد مناهج جاهزة؛ بل نصمم مسارك التعليمي خصيصاً بناءً على تقييم مستواك واحتياجاتك الشخصية.',
    'courses.subtitle.group': ' من التأسيس حتى البجروت وامتحان ياعيل (יע"ל)، بتركيز تام على المحادثة وكسر حاجز الخوف في بيئة تفاعلية',
    'courses.subtitle.enSolo': ' أتقن الإنجليزية بمسار فردي (1:1) تبدأ من التأسيس للمرحلة الابتدائية وصولاً لاحتراف البجروت وانتزاع الإعفاء الجامعي (Amir/Amiram). نمنحك طلاقة النطق وثقة التحدث بذكاء واحترافية.',
    'courses.subtitle.enGroup': 'بيئة تعليمية تفاعلية تعتمد على المشاركة الجماعية لتحقيق أفضل النتائج الأكاديمية عبر دورات اونلاين',
    ...
    // About
    'about.title': 'من نحن',
    'about.subtitle': 'نحن آكاديمية نجاح 2200 — رحلة نجاح تمتد لأكثر من عقد',
    'about.story': 'تأسست آكاديمية نجاح 2200 بهدف تمكين المجتمع العربي من إتقان اللغات العبرية والإنجليزية بأعلى معايير الجودة والاحترافية.',
    'about.mission': 'مهمتنا',
    'about.missionText': 'تقديم تعليم لغوي عالي الجودة يمكّن طلابنا من تحقيق أهدافهم المهنية والأكاديمية',
    'about.vision': 'رؤيتنا',
    'about.visionText': 'أن نكون الآكاديمية الرائد في تعليم اللغات في المنطقة من خلال أساليب تعليمية مبتكرة',
    'about.why': 'لماذا نجاح 2200؟',
    'about.reason1': 'معلمون متخصصون',
    'about.reason1Text': ' فريق من أفضل المعلمين ذوي الخبرة والكفاءة العالية حاصلين علي شهادات تدريس جامعيه',
    ...
    'terms.intro': 'باستخدامك لموقع نجاح 2200 فإنك توافق على الشروط والأحكام التالية:',
    'terms.section1Title': 'الشروط العامة',
    'terms.section1Text': 'يحق لآكاديمية نجاح 2200 تعديل هذه الشروط في أي وقت. يُنصح بمراجعة هذه الصفحة بشكل دوري.',
    ...
    'terms.section3Text': 'جميع المحتويات والمواد التعليمية هي ملكية حصرية لآكاديمية نجاح 2200.',
    'terms.section4Title': 'سياسة الإلغاء',
    'terms.section4Text': 'يرجى الملاحظة أن الرسوم الرسوم المدفوعة غير قابلة للاسترداد. ومع ذلك، يحق للطالب طلب تجميد الاشتراك أو تأجيله لموعد آخر، وذلك لضمان الاستفادة من المبلغ المدفوع وعدم خسارته في حال حدوث ظرف طارئ.',
  },
  he: {
    'nav.home': 'ראשי',
    'nav.courses': 'קורסים',
    ...
    'about.title': 'אודות',
    'about.subtitle': 'אנחנו מכון נג\'אח 2200 — מסע הצלחה של למעלה משני עשורים',
    'about.story': 'מכון נג\'אח 2200 נוסד במטרה להעצים את החברה הערבית בשליטה בשפות העברית והאנגלית בסטנדרטים הגבוהים ביותר.',
    ...
    'terms.intro': 'בשימוש באתר נג\'אח 2200 אתם מסכימים לתנאים והגבלות הבאים:',
    'terms.section1Title': 'תנאים כלליים',
    'terms.section1Text': 'מכון נג\'אח 2200 שומר לעצמו את הזכות לעדכן תנאים אלה בכל עת.',
    ...
    'terms.section3Text': 'כל התכנים וחומרי הלימוד הם רכוש בלעדי של מכון נג\'אח 2200.',
