...
const translations: Record<Language, Record<string, string>> = {
  ar: {
    ...
    // Courses
    'courses.title.solo': 'دوراتنا التعليمية للغه العبريه الفردية',
    'courses.title.group': 'دوراتنا التعليمية للغه العبريه الجماعية',
    'courses.title.enSolo': 'دوراتنا التعليمية للغه الانجليزية الفردية',
    'courses.title.enGroup': 'مجموعات التميز في اللغة الإنجليزية',
    'courses.subtitle.solo': 'في أكاديميتنا، ندرك أن لكل طالب قدراته الخاصة وتحدياته الفريدة، لذلك اخترنا أن تكون جميع دوراتنا الفردية  فردية بالكامل. نحن لا نتبع منهجاً ثابتاً للجميع، بل نقوم ببناء برنامجك التعليمي خصيصاً بناءً على تقييم مستواك الحالي واحتياجاتك الشخصية.',
    'courses.subtitle.group': 'لأن أهدافك تختلف عن الآخرين، صممنا لك نظاماً تعليمياً فردياً بالكامل. نحن لا نقدم دروساً عشوائية، بل دورات مُخصصة لكل هدف: سواء كنت تسعى لتأسيس أطفالك في المرحلة الابتدائية، تقوية المهارات الأساسية لطلاب الإعدادية، التفوق في امتحانات البجروت، أو اجتياز امتحان الأمير (Amir/Amiram) بجدارة للقبول الجامعي. نبني لك برنامجك الخاص الذي يركز على نقاط قوتك ويعالج ثغراتك بأعلى معايير الجودة، مع تركيز دائم على مهارة المحادثة.',
    'courses.subtitle.enSolo': 'مسارات تعليمية فردية مُصممة لكل مرحلة بذكاء واحترافية',
    'courses.subtitle.enGroup': 'بيئة تعليمية تفاعلية تعتمد على المشاركة الجماعية لتحقيق أفضل النتائج الأكاديمية.',
